...
<td><a href="/admin/news/<?php echo e($value->id); ?>/edit"><i class="fa fa-pencil" title="Edit"></i></a> 

	&nbsp;
     <form id="delete-frm" class="" action="<?php echo e(route('news.destroy', $value->id)); ?>" method="POST">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\larablog\resources\views/Admin/news/index.blade.php ENDPATH**/ ?>